...
const { getPlants, getPOs, getSizes, getDefectCategories, getDefectCodes,getModules, addFCAData, getFCAData, updateFCAData, deleteFCAData } = require("../controllers/fcaController");
